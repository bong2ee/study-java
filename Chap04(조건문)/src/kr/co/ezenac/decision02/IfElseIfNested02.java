 ...
 * 
 * 단, 성별을 입력받을 시에는 int로 입력받아 1이면 남자 2면 여자
 * 또한, 여자일 경우에 추가적인 정보 입력 대신
 * "여성에게는 국방의 의무가 없습니다."가 출력되게 만드시오.
 * 
 * 또한 남자이지만 미성년자일 경우
 * 추가적인 정보 입력 대신
 * "미성년자에게 아직 신체등급이 부여되지 않습니다."가 출력되게 만드시오. 
 */
...
public class IfElseIfNested02 {
	...
	public static void main(String[] args) {
		...
		if (gender == 1) {		//남자이므로 나이 입력
			System.out.println("나이 : ");
			int age = scan.nextInt();
			
			if (age >= 19) {		//성인이므로 신체등급 입력 받음
				System.out.println("신체등급(1~4) : ");
